...
2. The system creates a database record in the ``poll`` table with the following fields: ``poll_id, timestamp, team_id, channel_id, token, user_id, user_name, question, answers, channel_to_poll_id, published, closed``.
